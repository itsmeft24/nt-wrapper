...
impl Value {
    pub fn default() -> Self {
        Self { raw: NT_Value { type_: NT_Type_NT_UNASSIGNED, last_change: 0, server_time: 0, data: NT_Value__bindgen_ty_1{ v_int: 0 } } }
    }
...
impl NetworkTableEntry {
    pub fn get_value(&self) -> Option<Value> {
        ...
        unsafe {
            NT_GetEntryValue(self.handle, &mut value.raw as *mut NT_Value)
        }
...
impl NetworkTableInstance {
    pub fn get_default() -> NetworkTableInstance {
        NetworkTableInstance { handle: unsafe { NT_GetDefaultInstance() } }
    }
